...
wget -O https://raw.githubusercontent.com/appliedbinf/pima-docker/main/Interfaces/Preloaded.json
wget -O https://raw.githubusercontent.com/appliedbinf/pima-docker/main/Interfaces/pima_interface.py
